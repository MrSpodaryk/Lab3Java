...
class DishManagerTest {
	...
	public void setUp() {
		...
		dishes.add(new Wok(TypeOfMenu.STANDART_MENU, "грн", 250, "Diablo", Temperature.HOT, 420, LevelOfSpicy.EXTREME));
		dishes.add(
				new Sushi(TypeOfMenu.STANDART_MENU, "грн", 120, "Nori", Temperature.COLD, 120, LevelOfSpicy.NOT_SPICY));
		dishes.add(new Drinks(TypeOfMenu.STANDART_MENU, "грн", 150, "California", Temperature.COLD, 320,
				LevelOfSpicy.NOT_SPICY));
		dishes.add(new Dish(TypeOfMenu.STANDART_MENU, "грн", 400, "California", Temperature.COLD, 500,
				LevelOfSpicy.NOT_SPICY));
	}
	...
	void testFindDishByTypeOfMenu() {
		...
		Assertions.assertEquals(4, dishManager.findDishByTypeOfMenu(dishes, TypeOfMenu.STANDART_MENU).size());
	}
