...
public class Drinks extends Dish {
	...
	public String toString() {
		return super.toString() + ", capacity=" + capacity + ", presenceOfCaffeine=" + presenceOfCaffeine
				+ ", presenceOfLactose=" + presenceOfLactose;
	}

	public String getHeaders() {
		return super.getHeaders() + ", " + "capacity, presenceOfCaffeine, presenceOfLactose";
	}

	public String toCSV() {
		return super.toCSV() + capacity + ", " + presenceOfCaffeine + ", " + presenceOfLactose;
	}
}